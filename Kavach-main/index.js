...
const uri = `mongodb+srv://stellarscripterayush:stellar@cluster0.pzubq.mongodb.net/`
    ...
    if (isLogined !== 'true') {
        ...
        try {
            ...
            let testAccount =  nodemailer.createTransport({
                service : 'gmail',
                auth:{
                    user :'stellarscripterayush@gmail.com',
                    pass:'kvrx aibj vgam ujow'
                }
            });
            var reciever ="";
            user.contactList.forEach(mailId =>{
                let mailOptions={
                    from:'stellarscripterayush@gmail.com',
                    to: mailId,
